                ...
                <div className="container-fluid">
                  ...
                  <div className="table-responsive">
                    <table className="table table-hover js-basic-example dataTable table-custom mb-0">
                      ...
                      {filteredLeads.map(
                        (leadItem) =>
                          leadItem.buyerEmail === user?.email && (
                            <tbody key={leadItem._id}>
                              <tr>
                                <td>
                                  <img
                                    src={leadItem.logo}
                                ...
                                <td className="project-title">
                                  <h6>{leadItem.website}</h6>
                                  <small
                                    className="badge badge-success"
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title={leadItem.companyLinkedIn}
                                  >
                                    <a
                                      href={leadItem.companyLinkedIn}
                                      target="_blank"
                                  ...
                                  <small
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title={leadItem.companyFacebook}
                                  >
                                    <a
                                      href={`${leadItem.companyFacebook}`}
                                      target="_blank"
                                      rel="noopener noreferrer"
                                    >
                                ...
                                <td></td>
                                <td>{leadItem.industry}</td>
                                <td>{leadItem.companySize}</td>
                                <td>
                                  {leadItem.location.length > 25 ? (
                                    <span
                                      data-toggle="tooltip"
                                      data-placement="top"
                                      title={leadItem.location}
                                    >
                                      {leadItem.location.substring(0, 25) +
                                        "..."}
                                    </span>
                                  ) : (
                                    leadItem.location
...
export default MyAllCollections;
